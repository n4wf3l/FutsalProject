<div class="container mx-auto mt-8 max-w-lg">
    <h1 class="text-3xl font-bold mb-6 text-center">Add Staff Member</h1>
    ...
    <form action="{{ route('staff.store') }}" method="POST">
        ...
        <button type="submit" class="bg-green-500 text-white font-bold py-2 px-4 rounded">Add Staff Member</button>
    </form>
</div>