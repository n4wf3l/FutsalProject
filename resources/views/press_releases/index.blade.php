...
<head>
    ...
    <meta property="og:title" content="{{ __('messages.press_releases') }} | {{ $clubName }}" />
    <meta property="og:description" content="Restez informé des derniers communiqués de presse de {{ $clubName }}." />
    <meta property="og:type" content="website" />
    <meta property="og:url" content="{{ url()->current() }}" />
    @if($pressReleases->isNotEmpty() && $pressReleases->first()->image)
    <meta property="og:image" content="{{ asset('storage/' . $pressReleases->first()->image) }}" />
    @endif
    ...
    <meta name="twitter:title" content="{{ __('messages.press_releases') }} | {{ $clubName }}" />
    <meta name="twitter:description" content="Restez informé des derniers communiqués de presse de {{ $clubName }}." />
    @if($pressReleases->isNotEmpty() && $pressReleases->first()->image)
    <meta name="twitter:image" content="{{ asset('storage/' . $pressReleases->first()->image) }}" />
    @endif
    <meta name="twitter:url" content="{{ url()->current() }}" />

    <!-- Dublin Core Metadata -->
    <meta name="DC.title" content="{{ __('messages.press_releases') }} | {{ $clubName }}" />
