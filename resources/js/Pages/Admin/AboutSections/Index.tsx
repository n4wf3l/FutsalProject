...
export default function AboutSectionsIndex({ sections }: Props) {
    ...
    const bulkDelete = () => {
        router.delete('/about-sections/bulk', {
    ...
    return (
        <AdminLayout title="Sections À propos">
                                    ...
                                    >
                                        <td className="px-4 py-3">
                                            <input
                                                ...
                                                className="h-4 w-4 cursor-pointer accent-crimson"
                                                aria-label={`Sélectionner ${section.title}`}
                                            />
                                        </td>
                                        <td className="px-4 py-3">
            ...
            <ConfirmDialog
                open={confirmBulk}
                title={`Supprimer ${selected.size} section${selected.size > 1 ? 's' : ''} ?`}
                description="Cette action est irréversible. Les sections sélectionnées seront supprimées définitivement."
                confirmLabel="Supprimer"
                variant="destructive"
