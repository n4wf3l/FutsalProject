...
import { ArrowLeft, Camera, FileText, Loader2, Save, Trash2 } from 'lucide-react';
...
export default function PressReleaseForm({ pressRelease }: Props) {
    ...
    const submit: FormEventHandler = (e) => {
        e.preventDefault();
        const url = isEdit ? `/press_releases/${pressRelease!.id}` : '/press_releases';
    ...
    return (
        <AdminLayout>
            <Head title={isEdit ? 'Modifier communiqué' : 'Nouveau communiqué'} />
            ...
            <div className="mb-6">
                ...
                <div className="mt-3">
                    ...
                    <h1 className="mt-1 font-display text-3xl font-bold">
                        {isEdit ? pressRelease!.title : 'Créer un communiqué'}
                    </h1>
                </div>
            </div>
                ...
                >
                        ...
                        <div className="mt-4 space-y-5">
                            <Field label="Titre" required error={errors.title}>
                                <Input
                                    ...
                                    required
                                    placeholder="Communiqué officiel du club..."
                                />
                            </Field>
                            <Field
                                label="Contenu"
                    ...
                    <div className="flex items-center justify-end gap-3">
                        <Button asChild variant="outline" type="button">
                            <Link href="/press_releases">Annuler</Link>
                        </Button>
                        <Button type="submit" size="lg" disabled={processing}>
                            ...
                            {isEdit ? 'Enregistrer' : 'Créer le communiqué'}
                        </Button>
                    </div>
                </motion.div>
            </form>
