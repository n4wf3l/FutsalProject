...
export default function ChampionshipsIndex({ championships }: Props) {
    ...
    const bulkDelete = () => {
        router.delete('/championships/bulk', {
    ...
    return (
        <AdminLayout title="Championnats">
            ...
            <ConfirmDialog
                open={confirmBulk}
                title={`Supprimer ${selected.size} championnat${selected.size > 1 ? 's' : ''} ?`}
                description="Cette action est irréversible. Les championnats sélectionnés seront supprimés définitivement."
                confirmLabel="Supprimer"
                variant="destructive"
